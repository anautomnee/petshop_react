        ...
        <div className="container">
            <Stack
                ...
                <Stack>
                    ...
                    <Stack
                        direction={{ xxs: "column", xs: "column", sm: "column", md: "row", lg: "row", xl: "row" }}
                        mb={4}
                        gap={4}>
                        <ValueControl
                            page="product"
                    ...
                    <Typography
                        sx={{ width: { xxs: 420, xs: 420, sm: 420, md: 548, lg: 548, xl: 548 } }}
                        className="description" ref={descriptionRef}
                        variant="description">{product?.description}</Typography>
                    <Typography
